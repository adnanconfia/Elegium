        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgeMin = table.Column<string>(nullable: true),
                    AgeMax = table.Column<string>(nullable: true),
                    ...
                    WillCutHair = table.Column<string>(nullable: true),
                    WillShave = table.Column<string>(nullable: true),
                    WearsGlasses = table.Column<string>(nullable: true),
                    HasTattoo = table.Column<string>(nullable: true),
                    HasPiercings = table.Column<string>(nullable: true),
                    ...
                    IsVeg = table.Column<string>(nullable: true),
                    IsVegan = table.Column<string>(nullable: true),
                    IsHalal = table.Column<string>(nullable: true),
                    IsKosher = table.Column<string>(nullable: true),
