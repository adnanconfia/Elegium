...
$(document).ready(function() {
    ...
    //Get and set the user theme settings

    //if ($rootScope.BackgroundThings.DarkMode) {
    ...
    //END-Get and set the user theme settings

 //   // Full Dark mode
	//$(".setting_switch .btn-darkmode").on('change',function() {
 //       if (this.checked) {
 //           localStorage.dark_mode = "Y";
	//		$('body').addClass('dark-mode');
 //       } else {
 //           localStorage.dark_mode = "N";
	//		$('body').removeClass('dark-mode');
	//	}
 //   });
