...
angular.module('ngPatternCheck', [])
    .directive('ngPatternCheck', ['$log', function ($log, $timeout) {
        'use strict';

        function showDebugInfo() {
            $log.debug("[ngPatternCheck] " + Array.prototype.join.call(arguments, ' '));
        }
        ...
        return {
            ...
            compile: function uiPatternRestrictCompile() {
                ...
                return function ngPatternCheckLinking(scope, iElement, iAttrs, ngModelController) {
                    ...
                    function genericEventHandler(evt) {
                        ...
                        if (newValue === "" && iElement.attr("type") !== "text" && inputValidity && inputValidity.badInput) {
                            ...
                            if (ngModelController.$modelValue) {
                                iElement.addClass('is-valid');
                                iElement.removeClass('is-invalid');
                            }
                            setTimeout(function () {
                            ngModelController.$setValidity(iAttrs.name, true);
                            },100);
                        } else {
                            evt.preventDefault();
                            iElement.addClass('is-invalid');
                            setTimeout(function () {
                            ngModelController.$setValidity(iAttrs.name, false);
                            },100);
                            
                            DEBUG && showDebugInfo("New value did NOT pass validation against", regex, newValue, "Reverting back to:", oldValue, iAttrs.name);
                            //if (evt.type == 'change') {
                            //    evt.preventDefault();
                            //    //revertToPreviousValue();
                            //} 
                    ...
                    function tryParseRegex(regexString) {
                        try {
                            ...
                            throw "Invalid RegEx string parsed for ngPatternCheck: " + regexString;
                        }
                    }
                    ...
                    function bindListeners() {
                        ...
                        iElement.bind('keyup click blur', genericEventHandler);
                    ...
                    function unbindListeners() {
                        ...
                        //iElement.unbind('keypress', genericEventHandler);
                        ...
                        //iElement.unbind('change', genericEventHandler);

                        iElement.unbind('blur', genericEventHandler);
                    ...
                    function readPattern() {
                        var entryRegex = !!iAttrs.ngPatternCheck ? iAttrs.ngPatternCheck : iAttrs.pattern;
                    ...
                    iAttrs.$observe("ngPatternCheck", readPattern);
