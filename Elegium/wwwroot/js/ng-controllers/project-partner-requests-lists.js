myApp.controller('ProjectPartnerRequestsList', function ($scope, $filter, $http, $uibModal, toaster, $ngConfirm, $window, $state) {
    $http.get(root + 'api/ProjectPartnerRequest/GetMyOffers').then(
        (suc) => {
    ...
    $http.get(root + 'api/ProjectPartnerRequest/GetMyRequests').then(
        (suc) => {
        ...
        $ngConfirm({
            ...
            buttons: {
                deleteProject: {
                    ...
                    action: function () {
                        $http.post(root + 'api/ProjectPartnerRequest/TakeRequestAction/', offer).then(function success(response) {
