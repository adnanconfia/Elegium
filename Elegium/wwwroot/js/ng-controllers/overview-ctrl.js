myApp.controller('OverviewCtrl', function ($scope, $filter, $http, $uibModal, toaster, $state) {
    ...
    $scope.getDashbaordPanels = function () {
        $http.get(root + 'api/DashboardPanels/GetDashboardPanels').then(function success(response) {
    ...
    $scope.getUserDashbaordPanels = function () {
        $http.get(root + 'api/DashboardPanels/GetUserDashboardPanels').then(function success(response) {
    ...
    $scope.getMyCreatedTasks = function () {
        $http.get(root + 'api/Tasks/GetMyCreatedTasks/0').then(resp => {
    ...
    $scope.getMyTasks = function () {
        $http.get(root + 'api/Tasks/GetMyTasks/0').then(resp => {
    ...
    $scope.getDashboardStats = function () {
        $http.get(root + 'api/DashboardPanels/GetDashboardStats').then(resp => {
    ...
    $scope.getAllCrews = function () {
        $http.get(root + 'api/DashboardPanels/GetAllCrews').then(resp => {
            console.log(resp.data);
    ...
    $scope.savePanelSettings = function () {
        ...
        $http.post(root + 'api/DashboardPanels/UpdateUserDashboardPanels', items).then(resp => {
            console.log(resp);
            if (resp.status == 200) {
                toaster.pop({
                    type: 'success',
