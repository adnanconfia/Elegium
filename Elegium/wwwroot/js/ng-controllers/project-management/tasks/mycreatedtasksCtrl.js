myApp.controller('mycreatedtasksCtrl', function ($stateParams, $scope, $http, $state, $window, $window, $uibModal, $timeout, MenuService) {
    ...
    $http.get(root + 'api/Tasks/GetMyCreatedTasks/' + $stateParams.id).then(resp => {
