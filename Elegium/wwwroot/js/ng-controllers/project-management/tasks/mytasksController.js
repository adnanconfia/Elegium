myApp.controller('mytasksController', function ($stateParams, $scope, $http, $state, $window, $window, $uibModal, $timeout, MenuService) {
    ...
    $http.get(root + 'api/Tasks/GetMyTasks/' + $stateParams.id).then(resp => {
