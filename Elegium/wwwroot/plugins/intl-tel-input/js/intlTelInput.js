...
(function (factory) {
   ...
   ********************/
        ...
        _bindDropdownListeners: function () {
            ...
            // we add the class "highlight-country", so if they hit "enter" we know which one to select
        ...
        _handleUpDownKey: function (key) {
            var current = this.countryList.children("highlight-country").first();
        ...
        _handleEnterKey: function () {
            var currentCountry = this.countryList.children("highlight-country").first();
        ...
        _highlightListItem: function (listItem) {
            this.countryListItems.removeClass("highlight-country");
            listItem.addClass("highlight-country");
        },
